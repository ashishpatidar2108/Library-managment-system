...
// Models folder is missing in this project folder.
// const { UserModel, BookModel } = require("../models");
// Controllers folder is missing in this project folder yet.
...
router.get('/', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: getAllBooks' }));
...
//     })
// })  
router.get('/:id', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: getSingleBookById' }));
...
//     })          
// })
router.post('/', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: addNewBook' }));
...
router.put('/:id', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: updateBookById' }));
...
router.delete('/:id', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: deleteBookById' }));
...
router.get('/issued/for-users', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: getAllIssuedBooks' }));
