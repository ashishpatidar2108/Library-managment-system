...
// Controllers are not present in this project folder yet.
...
router.post('/', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: createUser' }));
...
//    })
// })
router.put('/:id', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: updateUserById' }));
...
//    })
// });
router.delete('/:id', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: deleteUserById' }));
...
router.get('/subscription-details/:id', (req, res) => res.status(501).json({ success: false, message: 'Not implemented: getSubscriptionDetailsById' }));
